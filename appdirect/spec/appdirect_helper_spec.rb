...
require_relative "../../appdirect/lib/appdirect/appdirect_error"
...
describe VCAP::Services::AppDirect::Helper do
  ...
  context "Activity Streams" do
      before do
        stub_fixture(:get, @api, VCAP::Services::AppDirect::Helper::OFFERINGS_PATH, "asms_dev/")
      end
      ...
      it "purchase_service should not allow creation due to missing code from AppDirect" do
        EM.run do
          f = Fiber.new do
            req = stub_fixture(:post, @api, VCAP::Services::AppDirect::Helper::SERVICES_PATH, "asms_dev/")
