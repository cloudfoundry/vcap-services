...
class VCAP::Services::Rabbit::Node
  ...
  def start_instance(instance)
    ...
    # Set default version to the instances already exist
    ...
    pid = Process.fork do
      ...
      config = ERB.new(File.read(File.expand_path(version_config["config_template"], __FILE__))).result(Kernel.binding)
