...
class VCAP::Services::Postgresql::Node
  ...
  def revoke_write_access(name, service)
      ...
      return revoke_write_access_internal(@connection, db_connection, service, @public_schema['public'])
  end
  ...
  def grant_write_access(name, service)
      ...
      return grant_write_access_internal(db_connection, service, @public_schema['public'])
  end
