...
require "postgresql_service/non_warden"
require "postgresql_service/warden"
...
class VCAP::Services::Postgresql::Node
  ...
  def create_database(provisionedservice)
    ...
    begin
      ...
      conn = global_connection(provisionedservice)
      unless conn
  ...
  def create_database_user(name, binduser, quota_exceeded)
    ...
    parent_binduser = instance.pgbindusers.all(:default_user => true)[0] unless binduser.default_user
