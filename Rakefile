...
SERVICES_DIR = %w(atmos couchdb echo elasticsearch filesystem memcached mongodb mysql neo4j oauth2 postgresql rabbit redis service_broker vblob tools/backup/manager marketplace ng/mysql ng/postgresql ng/vblob ng/mongodb ng/redis ng/rabbit ng/memcached)
