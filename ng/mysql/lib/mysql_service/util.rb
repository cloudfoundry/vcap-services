    ...
    module Mysql
      module Util
        ...
        def mysql_status(opts={})
          ...
          begin
            begin
              conn = Mysql2::Client.new(:host => opts[:host], :username => opts[:ins_user], :password => opts[:ins_pass], :database => opts[:db], :port => opts[:port], :socket => opts[:socket], :connect_timeout => 0.5)
            rescue Mysql2::Error => e
              # user had modified instance password, fallback to root account
              conn = Mysql2::Client.new(:host => opts[:host], :username => opts[:root_user], :password => opts[:root_pass], :database => opts[:db], :port => opts[:port], :socket => opts[:socket], :connect_timeout => 0.5)
